        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="p-2 rounded-lg bg-gradient-to-br from-emerald-600 to-teal-700 group-hover:shadow-lg group-hover:shadow-emerald-600/50 transition-all duration-300">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link href="/auth/signup">
              <Button className="bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white text-lg px-10 py-6 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group w-full sm:w-auto">
                Start Free
          ...
          <div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto mb-16">
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:border-emerald-300 hover:shadow-lg transition-all duration-300">
              <div className="text-3xl font-bold text-emerald-600">10K+</div>
              <div className="text-sm text-gray-600 font-medium">Active Users</div>
            </div>
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:border-teal-300 hover:shadow-lg transition-all duration-300">
              <div className="text-3xl font-bold text-teal-600">50ms</div>
              <div className="text-sm text-gray-600 font-medium">Response Time</div>
            </div>
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:border-slate-300 hover:shadow-lg transition-all duration-300">
              <div className="text-3xl font-bold text-slate-600">99.9%</div>
          ...
          <div className="rounded-2xl overflow-hidden border border-gray-300 shadow-xl hover:shadow-2xl transition-all duration-300 group">
            <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/0 via-teal-700/20 to-emerald-600/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              
              <div className="text-center relative z-10">
                <div className="mb-4 inline-flex items-center justify-center w-20 h-20 rounded-full bg-emerald-100 border border-emerald-300 group-hover:border-emerald-600 transition-all duration-300">
                  <ZapIcon className="w-10 h-10 text-emerald-600" />
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                {/* Content */}
                <h3 className="text-lg font-bold mb-3 text-gray-900 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-emerald-600 group-hover:to-teal-700 group-hover:bg-clip-text transition-all duration-300">
                  {feature.title}
                </h3>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  { icon: Code2, text: '50+ language support with syntax highlighting', color: 'text-emerald-600' },
                  { icon: Users, text: 'Real-time collaboration with your team', color: 'text-teal-600' },
                  { icon: Bot, text: 'Advanced AI assistance with code generation', color: 'text-slate-600' },
                  { icon: Cpu, text: 'Instant code execution and testing', color: 'text-emerald-700' },
                  { icon: GitBranch, text: 'Git integration with smart commits', color: 'text-teal-700' },
                  { icon: Shield, text: 'Enterprise security & compliance', color: 'text-slate-700' },
                ].map((item, i) => {
            ...
            <div className="space-y-6">
              <div className="p-8 rounded-2xl bg-white border border-gray-300 hover:border-emerald-400 hover:shadow-lg transition-all duration-300 group">
                <div className="flex items-center gap-4 mb-4">
                  <div className="p-3 rounded-lg bg-emerald-100 group-hover:bg-emerald-200 transition-all duration-300">
                    <Zap className="w-6 h-6 text-emerald-600" />
                  </div>
                  <h4 className="text-2xl font-bold text-gray-900">Lightning Fast</h4>
                </div>
                <p className="text-gray-700">50ms average AI response time with <span className="text-emerald-600 font-semibold">99.9% uptime</span></p>
              </div>

              <div className="p-8 rounded-2xl bg-white border border-gray-300 hover:border-teal-400 hover:shadow-lg transition-all duration-300 group">
                <div className="flex items-center gap-4 mb-4">
                  <div className="p-3 rounded-lg bg-teal-100 group-hover:bg-teal-200 transition-all duration-300">
              ...
              <div className="p-8 rounded-2xl bg-white border border-gray-300 hover:border-slate-400 hover:shadow-lg transition-all duration-300 group">
                <div className="flex items-center gap-4 mb-4">
                  <div className="p-3 rounded-lg bg-slate-100 group-hover:bg-slate-200 transition-all duration-300">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-4 bg-gray-100 border border-gray-300 rounded-full p-2 inline-block">
              ...
              >
                Yearly
                {billingCycle === 'yearly' && (
                  <span className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-emerald-600 text-white text-xs font-bold px-3 py-1 rounded-full whitespace-nowrap">
                    Save 20%
                  </span>
                )}
              </button>
            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`relative rounded-2xl transition-all duration-300 overflow-hidden group ${
                  plan.highlighted
                    ? 'border-2 border-emerald-600 shadow-2xl shadow-emerald-600/20 md:scale-105'
                    : 'border border-gray-200 hover:border-gray-300'
                }`}
              >
                {/* Background */}
                <div className={`absolute inset-0 ${plan.highlighted ? 'bg-gradient-to-br from-emerald-600/5 to-teal-700/5' : 'bg-white'}`} />

                {/* Popular Badge */}
                {plan.highlighted && (
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-emerald-600 to-teal-700 text-white px-4 py-1 rounded-full text-sm font-semibold">
                    Most Popular
                  </div>
                )}
                  ...
                  <ul className="space-y-4">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-start gap-3 group/item">
                        <CheckCircle className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0 group-hover/item:scale-110 transition-transform duration-300" />
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden">
            {/* Background gradient */}
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 via-teal-700 to-slate-600" />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-emerald-900 opacity-40" />
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                {['Features', 'Pricing', 'Security', 'Roadmap'].map((link) => (
                  <li key={link}>
                    <a href="#" className="hover:text-emerald-600 transition-colors duration-300">
                      {link}
                    </a>
                  </li>
                ))}
